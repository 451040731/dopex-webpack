...
(function(d, f, b) {
    ...
    var e = {
        ...
        reck: "The contents entered twice are inconsistent!",
        r: "Verified by information!",
                ...
                var p = {
                    ...
                    success: function(x) {
                        if (x.ok) {
                            ...
                            m[0].validform_valid = x.msg;
                            a.util.showmsg.call(v, x.msg, o.tiptype, {
                                obj: m,
                                type: 3,
                                sweep: o.tipSweep
                            });
                ...
                if (o.ajaxPost || r === "ajaxPost") {
                    ...
                    var p = {
                        ...
                        success: function(y) {
                            if (y.ok) {
                                w[0].validform_status = "posted";
                                a.util.showmsg.call(w, y.msg, o.tiptype, {
                                    obj: w,
                                    type: 2,
                                    sweep: o.tipSweep
                                }, "byajax")
